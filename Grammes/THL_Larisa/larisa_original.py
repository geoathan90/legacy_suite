...
df = pd.read_csv(HERE / "larisa2_2nd_submission.csv")

diags={"term":"31185","BA350":"31187","BA500":"31188","2000":"52740","1000":"31189", "700":"31858"}
...
loads = {"S5":600, "S5+8.00":600, "G5":700, "G5+8.00":700, "R5":800, "R5+8.00":800, 
         ...
         "TE5":1200, "TE5+8.00":1200, "TE5+18.00":1200, "Z5":800, "Z5+8.00":800, "ZE5":1600, "ZE5+8.00":1600, "Z5*":800,"Z5+8.00*":800}
...
for i in range(len(df)):
    ...
    df.loc[i,"max_load_kg"] =loads[sign2] * 2 * w
